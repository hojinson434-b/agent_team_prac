...
export default function Button({
  ...
  const variants = {
    ...
    secondary: 'border border-caramel text-chestnut-light rounded-button hover:bg-caramel hover:text-white focus:ring-caramel',
    ghost: 'text-chestnut-light hover:bg-rice rounded-button focus:ring-rice',
